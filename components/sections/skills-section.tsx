...
const techStack = [
  ...
  'PostgreSQL', 'Tailwind CSS', 'Redux', 'GraphQL', 'Docker', 'AWS',
  'Git', 'Jest', 'Socket.io', 'Webpack', 'Framer Motion', 'Prisma'
];
...
export function SkillsSection() {
  ...
  return (
    <section id="skills" className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden" ref={ref}>
      <ParticleField />
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          {[
            { title: 'Frontend', percentage: 92, description: 'Modern UI/UX with React ecosystem' },
            { title: 'Backend', percentage: 88, description: 'Scalable APIs and databases' },
            { title: 'DevOps', percentage: 78, description: 'CI/CD, Docker, and cloud deployment' },
          ].map((item, index) => (
                ...
                >
                  <svg className="w-24 h-24 transform -rotate-90">
                    ...
                    <motion.circle
                      ...
                      animate={inView ? { pathLength: item.percentage / 100 } : {}}
                      transition={{ duration: 2, delay: 1 + index * 0.2 }}
                      style={{ pathLength: 0 }}
                    />
                  </svg>
